...
export function ExpedienteHistory({ expediente, onClose }) {
  ...
  const getLocalidadLabel = (localidad) => {
    const labels = {
      'Formosa_Capital': 'Formosa Capital',
      'Clorinda': 'Clorinda',
      'El_Colorado': 'El Colorado',
      'Ingeniero_Juarez': 'Ingeniero Juárez',
      ...
      'Espinillo': 'Espinillo',
      'Pirane': 'Pirané',
      'San_Francisco_de_Laishi': 'San Francisco de Laishí',
      'Laguna_Yema': 'Laguna Yema',
      'General_Enrique_Mosconi': 'General Enrique Mosconi',
      'San_Hilario': 'San Hilario',
      'Villa_Trinidad': 'Villa Trinidad',
      'Mariano_Boedo': 'Mariano Boedo',
      'Gran_Guardia': 'Gran Guardia',
      'Mojon_de_Fierro': 'Mojón de Fierro',
      'Colonia_Pastoril': 'Colonia Pastoril'

    };
    return labels[localidad] || localidad;
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-1">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <span className="text-sm font-medium text-gray-700">Usuario en posesión:</span>
                  <span className="ml-2 text-sm text-gray-600">
                    {expediente.userId?.name || expediente.userId?.username || 'Desconocido'}
                  </span>
                </div>
                ...
                <div>
                  ...
                  <span className="ml-2 text-sm text-gray-600">{expediente.createdBy?.name || expediente.createdBy?.username || 'Desconocido'}</span>
                </div>
                <div className="mt-2">
                  <span className="text-sm font-medium text-gray-700">Conciliador Asignado:</span>
                  <span className="ml-2 text-sm text-gray-600">{expediente.conciliadorAsignado?.name || expediente.conciliadorAsignado?.username || 'Desconocido'}</span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className="ml-2 text-sm text-gray-600">{getLocalidadLabel(expediente.localidad)}</span>
                </div>
                <div>
